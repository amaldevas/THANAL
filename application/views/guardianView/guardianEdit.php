                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form action="<?php echo base_url(); ?>index.php/guardian/update" method="post" novalidate="novalidate">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Name</label>
                                                <input id="cc-pament" name="guardian_name" type="text" class="form-control" aria-required="true" aria-invalid="false" value="<?php echo $guardian_name; ?>">
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-number" class="control-label mb-1">Inmate</label>
                                                        <?php
                                                            foreach($result as $row)
                                                            {
                                                                if($row->id==$inmate_id)
                                                                {
                                                                    echo "<input id='cc-number' name='' type='tel' class='form-control cc-number identified visa' value='$row->name' data-val='true'
                                                    data-val-required='Please enter the card number' data-val-cc-number='Please enter a valid card number'
