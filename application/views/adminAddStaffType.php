                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">Add Staff Type</h3>
                                            <button class="au-btn au-btn-icon au-btn--blue">
                                                </button>
                                        </div>
                                        <hr>
                                        <form action="<?php echo base_url(); ?>index.php//admin/create-staff-type" method="post" novalidate="novalidate">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Staff Type</label>
                                                <input id="cc-pament" name="staff_type" type="text" class="form-control" aria-required="true" aria-invalid="false" value="">
                                            </div>
                                            <div>
