                            ...
                            <div class="col-lg-6" id="mail">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('<?php echo base_url(); ?>assets/images/bg-title-02.jpg');">
                                        ...
                                        <button class='au-btn-plus to-message' data-toggle='modal' message-id='$id' data-target='#scrollmodal'>
                                            <i class="zmdi zmdi-plus"></i>
                                        </button>
                                    </div>
     ...
     <div class="modal fade" id="scrollmodal" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
             <form action="<?php echo base_url(); ?>index.php/inmate/create-message" method="post" novalidate="novalidate">
    ...
    $(document).ready(function(){
        ...
        $.ajax({
                type : "POST",
                url : "<?php echo base_url();?>/index.php/inmate/get-result",
        ...
        $.ajax({
                type : "POST",
                url : "<?php echo base_url();?>/index.php/inmate/get-message",
