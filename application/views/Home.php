...
-->
	...
	<!-- stylesheets css -->
	<link rel="stylesheet" href="http://localhost/project-1/assets/css/bootstrap.min.css">
	<link rel="stylesheet" href="http://localhost/project-1/assets/css/animate.min.css">

  	<link rel="stylesheet" href="http://localhost/project-1/assets/css/et-line-font.css">
	<link rel="stylesheet" href="http://localhost/project-1/assets/css/font-awesome.min.css">

  	<link rel="stylesheet" href="http://localhost/project-1/assets/css/vegas.min.css">
	<link rel="stylesheet" href="http://localhost/project-1/assets/css/style.css">
		...
		<div class="row">
			...
			<div class="col-md-offset-2 col-md-8 col-sm-12">
				<div class="home-thumb">
					<h1 class="wow fadeInUp" data-wow-delay="0.4s">Elixir Of Lyf</h1>
          			<h3 class="wow fadeInUp" data-wow-delay="0.6s">We <strong>care</strong> for <strong>you</strong> No matter!</h3>
          			<a href="http://localhost/project-1/index.php/Login" class="btn btn-lg btn-default smoothScroll wow fadeInUp hidden-xs" data-wow-delay="0.8s">Sign in</a>
        			<a href="http://localhost/project-1/index.php/Signup" data-toggle="modal" data-target="#modal1" class="btn btn-lg btn-success smoothScroll wow fadeInUp" data-wow-delay="1.0s">Register</a>
				</div>
			</div>
...
<section id="about">
	<div class="container">
      ...
      <div class="col-md-6 col-sm-12">
        <img src="http://localhost/project-1/assets/images/about-img.png" class="img-responsive wow fadeInUp" alt="About">
      </div>
...
<!-- javscript js -->
<script src="http://localhost/project-1/assets/js/jquery.js"></script>
<script src="http://localhost/project-1/assets/js/bootstrap.min.js"></script>

<script src="http://localhost/project-1/assets/js/vegas.min.js"></script>

<script src="http://localhost/project-1/assets/js/wow.min.js"></script>
<script src="http://localhost/project-1/assets/js/smoothscroll.js"></script>
<script src="http://localhost/project-1/assets/js/custom.js"></script>
