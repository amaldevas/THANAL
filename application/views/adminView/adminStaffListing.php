                        ...
                        <div class="row">
                                    <div class="col-md-12">
                                        <div class="overview-wrap">
                                            <h2 class="title-1">staff listing</h2>
                                            <a href="<?php echo base_url(); ?>index.php/admin/add-staff">
                                                ...
                                                if(!empty($result))
                                                {
                                                    foreach($result as $row)
                                                    {
                                                         ...
                                                         Edit
                                                             ...
                                                             <td>
                                                                <a href='http://localhost:8081/Thanal/index.php//admin/delete-staff/$row->id'>
