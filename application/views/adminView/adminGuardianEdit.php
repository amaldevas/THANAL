                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form action="<?php echo base_url(); ?>index.php/admin/guardian-update/<?php echo $id; ?>" method="post" novalidate="novalidate">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                    <label for="select" class=" form-control-label">Inmate</label>
                                                    <select name="inmate_id" id="select" class="form-control">
                                                        <?php
