                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form action="<?php echo base_url(); ?>index.php/admin/update-staff/<?php echo $staff_id; ?>" method="post" novalidate="novalidate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                {
                                                        if($row->id==$staff_type_id)
                                                        {
                                                         echo "<option selected value='$row->id'>$row->staff_type</option>";
                                                        }
                                                        else
                                                        {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cc-pament" name="name" type="text" class="form-control" aria-required="true" aria-invalid="false" value="<?php echo $staff_name; ?>">
                                            </div>
                                            <div class="form-group has-success">
                                                ...
                                                <input id="cc-name" name="email" type="text" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"
                                                    autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name-error" value="<?php echo $staff_email; ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Inmate Access</label>
                                                        <br>
                                                        <label class="switch switch-3d switch-success mr-3">
                                                        <?php
                                                            if($can_view_inmate=="1")
                                                            {
                                                                echo"<input class='switch-input' name='can_view_inmate_medicine_schedule' type='checkbox' value='1' checked>";
                                                            }
                                                            else
                                                            {
                                                                echo"<input class='switch-input' name='can_view_inmate_medicine_schedule'  type='checkbox' value='1'>";
                                                            }
                                                          ?>
