 <!-- MAIN CONTENT-->
                                                ...
                                                <?php 
                                                    if(!empty($message_show))
                                                    {
                                                        foreach($message_show as $row)
                                                        {
                                                            ...
                                                            {
                                                                echo "
                                                                    <div class='au-message__item to-message' message-id='$row->id'>
                                                                        <div class='au-message__item-inner'>
                                                                            <div class='au-message__item-text'>
                                                                                <div class='avatar-wrap'>
                                                                                    <div class='avatar'>
    ...
    <!-- modal static -->
            <div class="modal fade" id="scrollmodal" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
             <form action="<?php echo base_url(); ?>index.php/admin/create-message" method="post" novalidate="novalidate">
    ...
    $(document).ready(function(){
        ...
        $.ajax({
                type : "POST",
                url : "<?php echo base_url();?>/index.php/admin/get-result",
