                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form action="<?php echo base_url(); ?>index.php/admin/create-inmate" method="post" novalidate="novalidate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cc-number" name="payment_per_month" type="tel" class="form-control cc-number identified visa" value="" data-val="true"
                                                    data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number"
                                                    autocomplete="cc-number">
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="cc-exp" name="emergency_contact_person" type="tel" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration"
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="emergency_contact_number" type="tel" class="form-control cc-cvc" value="" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
