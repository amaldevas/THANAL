                        ...
                        <div class="row">
                                    <div class="col-md-12">
                                        <div class="overview-wrap">
                                            ...
                                            <a href="<?php echo base_url(); ?>index.php/admin/add-medicine">
                                                    ...
                                                    foreach($result as $row)
                                                    {
                                                         echo "
                                                                 <tr>
                                                                        ...
                                                                        <td>
                                                                        <a href='http://localhost:8081/Thanal/index.php//admin/medicine-edit/$row->id'>
                                                         ...
                                                         Edit
                                                                                ...
                                                                                <td>
                                                                                <a href='http://localhost:8081/Thanal/index.php//admin/medicine-edit/$row->id'>
                                                                 <button type='button' class='btn btn-secondary btn-sm'>Inmate</button>
                                                                 </button>
                                                                                </a>
                                                             </td>
                                                             <td>
                                                                <button type='button' class='btn btn-danger btn-sm to-delete' data-toggle='modal' delete-id='$row->id' data-target='#staticModal'>
                                            Delete
                                        </button>
                                                             </td>
                                                                                </tr>
