                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Staff Profile</h2>
                                    <a href="<?php echo base_url(); ?>index.php/admin/edit-staff/<?php echo $staff_id; ?>">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="mx-auto d-block">
                                            ...
                                            <h5 class="text-sm-center mt-2 mb-1"><?php echo $staff_name; ?></h5>
                                            <div class="location text-sm-center">
                                                <i class="fa"></i> <?php echo $staff_email; ?></div>
                                        </div>
                                        <hr>
                    ...
                    <div class="row ">
                        <div class="col-md-4">
                         <div class="typo-headers">
                             ...
                             <h4 class="pb-2 display-5">Staff Type</h4>
                         </div>
                         </div>
                         <div class="col-md-7 offset-md-1">
                            <div class="typo-articles">
