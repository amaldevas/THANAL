                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form action="<?php echo base_url(); ?>index.php/admin/guardian-create" method="post" novalidate="novalidate">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Name</label>
                                                <input id="cc-pament" name="guardian_name" type="text" class="form-control" aria-required="true" aria-invalid="false" value="">
                                            </div>
