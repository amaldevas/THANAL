...
<head>
    ...
    <!-- Title Page-->
    <title>Admin Staff Listing</title>
    ...
    <link href="<?php echo base_url(); ?>assets/css/theme.css" rel="stylesheet" media="all">
      ...
      <script type="text/javascript">
        ...
        {
             $('.schdl_btn').click(function() 
            {
                window.location = "<?php echo base_url(); ?>index.php/admin/staff-Delete";
            });
             $('.add_staff_type').click(function() 
            {
                window.location = "<?php echo base_url(); ?>index.php//admin/add-staff-type";
            });
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <input class="au-input au-input--xl" type="text" name="search" placeholder="Search for Staff" />
                ...
                <div class="section__content section__content--p30">
                        ...
                        <div class="row">
                                    <div class="col-md-12">
                                        <div class="overview-wrap">
                                            <h2 class="title-1">staff type listing</h2>
                                            <a href="<?php echo base_url(); ?>index.php/admin/add-staff/$id">
                                            <button class="au-btn au-btn-icon au-btn--blue add_staff_type">
                                        <i class="zmdi zmdi-plus"></i>add staff type</button>
                                        </a>
                                        </div>
                                    </div>
                        </div>
                    ...
                    <div class="row m-t-30 ">
                            <div class="col-md-12">
                                        ...
                                        <tbody>
                                            <?php
                                                foreach($staff_type as $row)
                                                {
                                                         echo "
                                                                 <tr>
                                                                        <td class='process'>$row->staff_type</td>
                                                                        <td>
                                                                        <a href='http://localhost:8081/Thanal/index.php//admin/staff-type-edit/$row->id'>
                                                                        <button class='btn btn-success btn-sm edit_btn' value='$row->id'>
                                                 ...
                                                 <td>
                                                    <a href='http://localhost:8081/Thanal/index.php//admin/delete-staff-type/$row->id'>
                                                                        <button class='btn btn-danger btn-sm edit_btn' value='$row->id'>
                                ...
                                <a href='base_url();/deletestaff-type/$row->id''>
                                </a>
                                <!-- END DATA TABLE-->
                            </div>
                        </div>
