            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                   <ul class="list-unstyled navbar__list">
                        <li class="has-sub">
                            <a class="js-arrow" href="<?php echo base_url();?>index.php/inmate/dashboard">
                                <i class="fas fa-tachometer-alt"></i>Dashboard</a>
                                </li>
                                <li class="has-sub">
                                  <a class="js-arrow" href="<?php echo base_url();?>index.php/inmate/profile">
                                <i class="fas fa-tachometer-alt"></i>Profile </a>
                                </li>
                                <li class="has-sub">
                                  <a class="js-arrow" href="<?php echo base_url();?>index.php/inmate/medicine">
                                <i class="fas fa-tachometer-alt"></i>Medicine</a>
                                </li>
                                <li class="has-sub">
                                  <a class="js-arrow" href="<?php echo base_url();?>index.php/inmate/schedule">
                                                    ...
                                                    if(!empty($message_show))
                                                    {
                                                        foreach($message_show as $row)
                                                        {
                                                            ...
                                                            echo "
                                                                    ...
                                                                    <img src='http://localhost:8081/Thanal/assets/images/icon/avatar-01.jpg' alt='Cynthia Harvey' />
                                                                </div>
                                                                 <div class='content'>
                                                                <p>$row->subject</p>
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <a href="<?php echo base_url();?>index.php/inmate/profile">
                                            ...
                                            <div class="account-dropdown__footer">
                                                <a href="<?php echo base_url();?>index.php/inmate/logout">
