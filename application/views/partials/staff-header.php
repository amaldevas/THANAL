                   ...
                   <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            <a class="js-arrow" href="<?php echo base_url()?>index.php/staff/dashboard">
                                ...
                                <li class="active has-sub">
                                  <a class="js-arrow" href="<?php echo base_url()?>index.php/staff/list-inmate">
                                <i class="fas fa-tachometer-alt"></i>Inmate Listing </a>
                                </li>
                                  <li class="active has-sub">
                                  <a class="js-arrow" href="<?php echo base_url()?>index.php/staff/list-guardian">
                                <i class="fas fa-tachometer-alt"></i>Guardian Listing </a>
                                </li>
                                <li class="active has-sub">
                                  <a class="js-arrow" href="<?php echo base_url()?>index.php/staff/list-medicine">
                                <i class="fas fa-tachometer-alt"></i>Medicine Listing </a>
                                </li>
                                <li class="active has-sub">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="<?php echo base_url(); ?>index.php/staff/search-results" method="POST">
                                <select name="type" id="select" class="form-control au-input sear">
