                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a class="js-arrow" href="<?php echo base_url(); ?>index.php/admin/list-inmate>
                                <i class="fas fa-copy"></i>Inmate Profile</a>
                        </li>
                        <li>
                            <a class="js-arrow" href="<?php echo base_url(); ?>index.php/admin/list-guardian>
                                <i class="fas fa-copy"></i>Teet Results</a>
                        </li>
                        <li>
                            <a class="js-arrow" href="<?php echo base_url(); ?>index.php/admin/list-medicine>
                                <i class="fas fa-copy"></i>Medicine Details</a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <li class="has-sub">
                            <a class="js-arrow" href="<?php echo base_url(); ?>index.php/guardian/dashboard">
                                <i class="fas fa-tachometer-alt"></i>Dashboard</a>
                        </li>
                        <li>
                            <a class="js-arrow" href="<?php echo base_url(); ?>index.php/guardian/profile">
                                <i class="fas fa-copy"></i>Profile</a>
                        </li>
                        <li>
                            <a class="js-arrow" href="<?php echo base_url(); ?>index.php/guardian/inmate-profile">
                                <i class="fas fa-copy"></i>Inmate Profile</a>
                        </li>
                        <li>
                            <a class="js-arrow" href="<?php echo base_url(); ?>index.php/admin/list-guardian">
                                <i class="fas fa-copy"></i>Test Results</a>
                        </li>
                        <li>
                            <a class="js-arrow" href="<?php echo base_url(); ?>index.php/guardian/list-medicine">
                                <i class="fas fa-copy"></i>Medicine Details</a>
                        </li>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="<?php echo base_url(); ?>index.php/admin/search-results" method="POST">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <a href="<?php echo base_url(); ?>index.php/guardian/profile">
                                                ...
                                                <div class="account-dropdown__item">
                                                    <a href="<?php echo base_url(); ?>index.php/guardian/password-change">
                                                        <i class="zmdi zmdi-settings"></i>Change Password</a>
                                                </div>
                                            </div>
                                            <div class="account-dropdown__footer">
                                                <a href="<?php echo base_url(); ?>index.php/guardian/logout">
