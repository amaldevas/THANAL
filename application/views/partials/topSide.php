                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a class="js-arrow" href="<?php echo base_url(); ?>index.php/admin/list-guardian">
                                <i class="fas fa-copy"></i>Guardian</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="js-arrow" href="<?php echo base_url(); ?>index.php/admin/medicine-order">
                                <i class="fas fa-copy"></i>Medicine Order</a>
                        </li>
                         <li>
                            <a class="js-arrow" href="<?php echo base_url(); ?>index.php/admin/shift">
                                <i class="fas fa-copy"></i>Shift</a>
                        </li>
                         <li>
                            <a class="js-arrow" href="<?php echo base_url(); ?>index.php/admin/duty">
                                <i class="fas fa-copy"></i>Duty</a>
                        </li>
                        <li>
                            <a class="js-arrow" href="<?php echo base_url(); ?>index.php/admin/birthday">
                                <i class="fas fa-copy"></i>Upcoming Birthday</a>
                        </li>
                    </ul>
                </div>
            </nav>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="<?php echo base_url(); ?>index.php/admin/search-results" method="POST">
                                                    ...
                                                    <select name="type" id="select" class="form-control au-input">
