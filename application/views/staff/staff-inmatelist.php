                        ...
                        <div class="row">
                                    <div class="col-md-12">
                                        <div class="overview-wrap">
                                            <h2 class="title-1">inmate listing</h2><a href="http://localhost:8081/Thanal/index.php/staff/addinmate">
                                        ...
                                        <tbody>
                                             <?php 
                                                if(!empty($result))
                                                {
                                                    ...
                                                    <tr>
                                                          <td><a href='http://localhost:8081/Thanal/index.php/staff/inmate/profile/$row->id' class='nameColor'>$row->name</a></td>
                                                       
                                                        <td>$row->email</td>
                                                        <td>$row->gender</td>
                                                        <td>$row->mobile</td>
                                                        <td>$row->date_of_joining</td>
                                                        <td><a href= 'http://localhost:8081/Thanal/index.php/staff/inmate-edit/$row->id'>
...
<!-- modal static -->
    ...
    $(document).ready(function(){
        $(".to-delete").click(function(){
            ...
            $(".delete-confirm").attr('href','http://localhost:8081/Thanal/index.php/staff/inmate-delete/'+deleteId);
