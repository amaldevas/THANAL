                        ...
                        <div class="row">
                                    <div class="col-md-12">
                                        <div class="overview-wrap">
                                            <h2 class="title-1">Medicine listing</h2><a href="http://localhost:8081/Thanal/index.php/staff/add-medicine">
                                ...
                                <div class="table-responsive m-b-40">
                                    <table class="table table-borderless table-data3">
                                        <thead>
                                            <tr>
                                                <th>Medicine Name</th>
                                                <th>Available Medicine Stock</th>
                                                <th>Medicine Representative</th>
                                                <th>mobile</th>
                                                <th>edit</th>
                                                <th>Inmate</th>
                                                <th>delete</th>
                                             ...
                                             <?php 
                                                if(!empty($result))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href= 'http://localhost:8081/Thanal/index.php/staff/medicine-edit/$row->id'>
                                                        ...
                                                        <td><a href= 'http://localhost:8081/Thanal/index.php/staff/inmate-d/$row->id'>
                                                            <button type='button' class='btn btn-secondary btn-sm schdl_btn'>Inmate</button>
                                                            </a>
                                                        </td>
    ...
    $(document).ready(function(){
        $(".to-delete").click(function(){
            ...
            $(".delete-confirm").attr('href','http://localhost:8081/Thanal/index.php/staff/medicine-delete/'+deleteId);
