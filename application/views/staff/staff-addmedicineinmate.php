                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">Medicine Taken</h3>
                                            <div class="row">
                                        ...
                                        <hr>
                                        <form action="http://localhost:8081/Thanal/index.php/staff/update-inmate/<?php echo $inmateid;?>" method="post" novalidate="novalidate">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">Payment Per month</label>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="payment" type="tel" class="form-control cc-cvc" value="<?php echo $payment_per_month; ?>" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="cc-exp" name="emergencycontactperson" type="tel" class="form-control cc-exp" value="<?php echo $emergency_contact_person;?>" data-val="true" data-val-required="Please enter the card expiration"
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="emergencycontactnumber" type="tel" class="form-control cc-cvc" value="<?php echo $emergency_contact_number;?>" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
