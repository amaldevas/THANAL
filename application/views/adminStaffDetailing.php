      ...
      <script type="text/javascript">
        $(document).ready(function()
        {
            $('.edit_btn').click(function() 
            {
                ...
                window.location = "<?php echo base_url(); ?>index.php/admin/edit-staff";
            });
             $('.delete_btn').click(function() 
            {
                confirm("Are you sure want to delete selected content");
            });
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="<?php echo base_url(); ?>index.php/admin/list-staff">Staff Listing</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>index.php/
admin/staff-detail">Staff Detail</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>index.php/
admin/staff-detail">Staff Edit</a>
                                </li>
                                <li>
                                    <a href="index.html">Staff Schedule History</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="index.html">Inmate Listing</a>
                                </li>
                                <li>
                                    <a href="index.html">Inmate Detail</a>
                                </li>
                                <li>
                                    <a href="index.html">Inmate Edit</a>
                                </li>
                                <li>
                                    <a href="index.html">Inmate Schedule History</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a class="js-arrow" href="#">
                                <i class="fas fa-copy"></i>Medicine Scheduling</a>
                        </li>
                    </ul>
                </div>
            </nav>
                        ...
                        <div class="row">
                                    <div class="col-md-12">
                                        <div class="overview-wrap">
                                            <h2 class="title-1">staff details</h2>
                                        </div>
                                    </div>
                        </div>
                    </div>
